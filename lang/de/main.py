...
def load_themes():
    ...
    # Full path to the set.json file
    styles_json_path = os.path.join(src_dir, 'styles_de.json')  
    # Check if the set.json file exists in the 'set' directory
...
class YouTubeDownloaderApp:
    def __init__(self, root):
        ...
        customtkinter.CTkLabel(root, text="Auflösung:").grid(row=1, column=0, padx=10, pady=10)
        ...
        self.audio_only_check = customtkinter.CTkCheckBox(
            root, text="Nur Audio (MP3)", variable=self.audio_only_var, onvalue="True", offvalue="False"
        )
        ...
        self.playlist_check = customtkinter.CTkCheckBox(
            root, text="Playlist herunterladen", variable=self.playlist_var, onvalue="True", offvalue="False"
        )
        ...
        self.select_download_path_button = customtkinter.CTkButton(root, text="Download Pfad auswählen", command=self.select_download_path)
        ...
        # Download button
        self.download_btn = customtkinter.CTkButton(root, text="Herunterladen", command=self.on_download)
        self.download_btn.place(x=150,y=200)

        # Multi Download button
        self.download_multi_btn = customtkinter.CTkButton(root, text="Mehrfaches Herunterladen", command=self.on_multi_download)
    ...
    def on_download(self):
        ...
        if audio_only:
            messagebox.showinfo("Erfolg", "Der Audio-Download (MP3) wurde erfolgreich abgeschlossen!")
        else:
            messagebox.showinfo("Erfolg", "Der Video-Download (MP4) wurde erfolgreich abgeschlossen!")
    ...
    def on_multi_download(self):
        ...
        self.download_single_btn = customtkinter.CTkButton(root, text="Einfaches Herunterladen", command=self.on_single_download)
    ...
    def multi_download(self):
        ...
        if not urls_string:
            print("Keine gültigen URLs eingegeben.")
            return
    ...
    def removelink(self):
        ...
        if self.entry_count > 0:
            ...
            print("Es gibt keine Eingabefelder zum Entfernen!")

    def on_single_download(self):
        self.download_single_btn.destroy()
        self.download_multi_btn = customtkinter.CTkButton(self.root, text="Mehrfaches Herunterladen", command=self.on_multi_download)
        self.download_multi_btn.place(x=300,y=200)  
        self.root.geometry("600x280")  # Width x Height
        self.audio_only_check.place(x=200, y=108)
        self.playlist_check.place(x=350, y=108)
    ...
    def open_settings_window(self):
        ...
        # Mappings
        color_mapping = {"dark-blue": "Dunkelblau", "NightTrain": "NightTrain", "Hades": "Hades", "MoonlitSky": "MoonlitSky","NeonBanana": "NeonBanana"}
        print(color_name)
        theme_mapping = {"dark": "Dunkel", "light": "Hell"}
        ...
        # Aussehen-Label
        ctk.CTkLabel(self.root_2, text="Aussehen", width=100, height=40, font=("Arial", 20, "bold")).place(x=150, y=10)
        ...
        ctk.CTkLabel(appearance_box, text="Thema:").place(x=10, y=10)
        ...
        ctk.CTkLabel(appearance_box, text="Farb-Thema:").place(x=10, y=60)
        self.color_combobox = ctk.CTkComboBox(
            appearance_box, 
            values=["Dunkelblau", "NightTrain", "Hades", "MoonlitSky","NeonBanana"], 
    ...
    def change_theme(self, selected_theme):
        ctk = customtkinter
        # Mapping von Themen
        theme_mapping = {"Dunkel": "dark", "Hell": "light"}
    ...
    def change_color(self, selected_color):
        ...
        if color_file:
            ...
            print("Ungültiges Farbthema gewählt.")
